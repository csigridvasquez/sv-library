---
{"dg-publish":true,"permalink":"/homebrew-mechanics/","dgHomeLink":true}
---

# Homebrews: Rules & Mechanics

## ⚙️Rule
**What it is:** A directive that says _what you can or can’t do_ in the game.
...
## ⚙️ Mechanic
**What it is:** A system or procedure that explains _how something works_ in the game.
...
>[!example]- Examples of downtime activities:
>>[!check]- **Buying a Magic Item**
...
## Mood
Mood tracks a character’s emotional state and how it affects their actions in play. It adds a light mechanical layer to reflect highs and lows in the story. Each character has a Mood Track from 0 to 12, starting at 6 (Content). Mood shifts up or down based on events or roleplay.
- [[#GM Inspiration|Inspiration]] gained from a positive mood stacks up to two times.
- Mood effects are gained and lost as soon as the player is in a new mood.

| 12   | Euphoric       | Get **[[#GM Inspiration\|Inspiration]]**. Inspiration from Euphoric mood is stackable.                                 |
| ---- | -------------- | ---------------------------------------------------------------------------------------------------------------------- |
| 9-11 | Content        | Get [[#GM Inspiration\|Inspiration]].                                                                                  |
...
Positive social interaction/role play
Victorious                                  
Beautiful scenery (+1)
Acts of kindness (+1)
Catharsis 
Not enough Rations (-2)
Bedroom too crowded (-1)
